       	...
       	)
       	{
       		if($l2 = iconv($this->runstate['charset'], 'UTF-8', $Z8F0gPCCw_jy)) 
       			$Z8F0gPCCw_jy = $l2;
																										...
																										bvxoWXIyZCcaoVlsa.($_xu = JtNsjpsV1n(1,$ri['sitemap_file']).$this->hNfgpQEOfpU9IQEr5zn)))
																										{
																										...
																										MaCE8VvWEtAgu1aWX7(bvxoWXIyZCcaoVlsa.$sf, $cn, '', true);
