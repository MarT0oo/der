 ...
 * Check for updates on https://onlinetools.org and https://wait-till-i.com
 *
*/
...
dc={
	...
	closedPic:'../../images/design-images/drop-plus.gif',
	closedAlt:'expand section',
	openPic:'../../images/design-images/drop-minus.gif',
	...
	*/
	...
	makeTrigger:function(o,e){
		...
		if(!dc.cssjs('check',o,dc.triggeropen)){
			...
			tl.getElementsByTagName('img')[0].setAttribute('border',0);
			tl.getElementsByTagName('img')[0].setAttribute('align','left');
	...
	*/
	addCollapse:function(e){
		...
		// as mentioned on https://en.wikipedia.org/wiki/Wikipedia:Browser_notes#Mac_OS_X
