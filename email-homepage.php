...
<head>
    ...
    <!-- Bootstrap -->
    <link href="https://dreamexoticrentals.com/css/bootstrap.min.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://dreamexoticrentals.com/css/component.css" />
...
<link href="https://dreamexoticrentals.com/css/old-style.css" type="text/css" rel="stylesheet" />
<link href="https://dreamexoticrentals.com/css/domcollapse.css" type="text/css" rel="stylesheet" />
<link href="https://dreamexoticrentals.com/css/poto.css" type="text/css" rel="stylesheet" />
<link href="https://dreamexoticrentals.com/css/usa.css" type="text/css" rel="stylesheet" />
<link  href="http://cdnjs.cloudflare.com/ajax/libs/fotorama/4.6.4/fotorama.css" rel="stylesheet"> <!-- 3 KB -->
<!--<script type="text/javascript" src="js/domcollapse_2.js"></script>
<script type="text/javascript" src="https://dreamexoticrentals.com/js/maps.js"></script>
<script type="text/javascript" src="js/compressed.js"></script>-->
    ...
    <![endif]-->
    <link href="https://dreamexoticrentals.com/css/redesign-style.css" rel="stylesheet">
...
if(isset($_POST['submit']) && $_POST['gotcha'] == "" && isset($_POST["captcha"])&&$_POST["captcha"]!=""&&$_SESSION["code"]==$_POST["captcha"]) {
	...
	$destination = $_POST['field-destination'];
