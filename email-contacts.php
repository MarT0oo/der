...
if(isset($_POST['submit1']) && $_POST['gotcha1'] == "" ) {

	$fname = $_POST['field-agentname'];
	$email = $_POST['field-agentemail'];
	$phone = $_POST['field-agentphone'];
	$subject = $_POST['field-agentsubject'];
	$message = $_POST['field-agentmessage'];

	$curPageURL = $_SERVER['HTTP_REFERER'];

	$emailTo = 'msalazar@dreamexoticrentals.com';
	// $emailTo = 'marto.apostolov@gmail.com';
	$subject ='Sent from DreamExoticRentals.com Contacts page - Marketing form';
	$body = strip_tags("Subject: $subject \n\nName: $fname\nEmail: $email\nPhone: $phone\nSubject: $subject\n\nComment:\n $message\n\nPage URL: $curPageURL");
	$headers = 'From: Dream Exotic Rentals Form <'.$emailTo.'>' . "\r\n" . 'Reply-To: ' . $email . "\r\n" . 'Bcc: leo@dreamexoticrentals.com';
